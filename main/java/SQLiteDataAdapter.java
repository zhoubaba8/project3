...
public class SQLiteDataAdapter implements IDataAdapter {
    ...
    public int cancelPurchase(PurchaseModel purchase) {
        try {
            Statement stmt = conn.createStatement();
            ...
            String sql = "DELETE FROM Purchases WHERE PurchaseID = " + purchase.mPurchaseID;
            System.out.println(sql);
            ...
            String msg = e.getMessage();
            System.out.println(msg);
            if (msg.contains("UNIQUE contraint failed"))
